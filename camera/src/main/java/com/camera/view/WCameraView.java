 ...
 */
public class WCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
        .Callback, CameraView {
//    private static final String TAG = "JCameraView";
    ...
    //回调监听
    private WCameraListener jCameraLisenter;
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setJCameraLisenter(WCameraListener jCameraLisenter) {
    ...
    public void playVideo(Bitmap firstFrame, final String url) {
        videoUrl = url;
        WCameraView.this.firstFrame = firstFrame;
